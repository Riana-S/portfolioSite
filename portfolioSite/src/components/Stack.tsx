...
interface StackProps {
    ...
    onTopCardChange?: (topCardId: number) => void; // 👈 add this
  }
  ...
  export default function Stack({
    ...
    // 👇 whenever topCard changes, notify the parent (About)
    useEffect(() => {
      if (onTopCardChange) onTopCardChange(topCard.id);
    }, [topCard, onTopCardChange]);
